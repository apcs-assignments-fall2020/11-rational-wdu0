public class Rational
{
    ...
    public static Rational simplify(Rational r)
    {
        ...
        int nu = r.numerator / factor;
        int de = r.denominator / factor;
        Rational result = new Rational(nu, de);
        return result;
    }
    ...
    {
        int newsecnu = s.denominator;
        int newsecde = s.numerator;
        Rational newsec = new Rational(newsecnu, newsecde);
        Rational x = multiply(r, newsec);
        return x;
    }
